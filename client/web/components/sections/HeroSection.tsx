...
export function HeroSection() {
  return (
    <section className="relative flex min-h-[calc(100svh_-_5rem)] items-center overflow-hidden py-16 sm:py-20 lg:py-24">
      ...
      <Container className="relative z-10">
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-8 text-center">
          <h1 className="text-5xl font-bold uppercase leading-[1.05] sm:text-6xl lg:text-7xl xl:text-8xl">
            Студентська рада ФІОТ
          </h1>
          <p className="max-w-xl text-lg text-muted sm:text-xl lg:text-2xl">
            Ми знайшли баланс між незалежністю та ефективною співпрацею — зі
            студентами, університетом і партнерами.
          </p>
          <a
            href="#about"
            className="mt-2 inline-flex items-center justify-center rounded-2xl bg-gradient-main px-10 py-4 text-xl font-bold text-black transition-opacity hover:opacity-90 lg:px-14 lg:py-5 lg:text-2xl"
          >
            Дізнатись більше
          </a>
        </div>
