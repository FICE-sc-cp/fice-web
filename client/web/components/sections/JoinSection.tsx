...
const COLUMNS: { title: string; text: string }[][] = [
  [
    ...
    },
    {
      ...
      text: "Бери участь у важливих рішеннях та ініціативах",
    },
  ],
  [
    {
      title: "Нова знайомства",
      text: "Розширюй коло спілкування з активними студентами",
    },
    { title: "Цікаві проєкти", text: "Реалізуй свої ідеї та креативність" },
  ],
];
