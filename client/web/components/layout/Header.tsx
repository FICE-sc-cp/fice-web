      ...
      <Container>
        <div className="relative">
          ...
          <div className="relative flex items-center justify-between gap-4 rounded-2xl bg-gradient-main px-4 py-3 shadow-lg shadow-black/20 sm:px-6">
              ...
              {NAV.map((item) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={cn(
                        "relative text-lg font-bold text-stone-950 after:absolute after:-bottom-1 after:left-0 after:h-0.5 after:w-0 after:rounded-full after:bg-stone-950 after:transition-all after:duration-300 group-hover:after:w-full",
                        active && "after:w-full",
                      )}
                    >
                      {item.label}
            ...
            <Link
              href={ctaHref}
              className="hidden shrink-0 justify-center whitespace-nowrap rounded-lg bg-stone-950 px-2 py-1.5 text-center text-lg font-bold text-white transition-opacity hover:opacity-80 sm:inline-flex sm:w-[13.5rem]"
            >
              {ctaLabel}
            </Link>
